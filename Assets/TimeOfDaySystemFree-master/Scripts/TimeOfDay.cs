...
namespace AC.TimeOfDaySystemFree
{
    ...
    public abstract class TimeOfDay : MonoBehaviour
    {
        ...
        [SerializeField]
        [Range(-180f, 180f)]
        protected float m_WorldLongitude = 25f;
        ...
        [SerializeField]
        [Range(0, 5f)]
        protected float m_MoonLightIntensity = .2f;
        ...
        [SerializeField]
        [Range(0, 8f)]
        protected float m_AmbientIntensity = 1f;
        ...
        [SerializeField]
        [Range(0, 1f)]
        protected float m_FogDensity = 0.001f;
