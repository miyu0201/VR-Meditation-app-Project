...
namespace AC.TimeOfDaySystemFree
{
    ...
    public class TimeOfDayManager : TimeOfDay
    {
        ...
        [SerializeField]
        [Range(0, 5f)]
        private float m_AtmosphereThickness = 1;
        ...
        [SerializeField]
        [Range(.03f, 2f)]
        private float m_HorizonFade = 1.5f;
        ...
        [SerializeField]
        [Range(0, 5f)]
        protected float m_MoonIntensity = 1;
        ...
        [SerializeField]
        [Range(0, 1f)]
        protected float m_MoonSize = .096f;
        ...
        [SerializeField]
        [Range(0, 10f)]
        private float m_MoonHaloSize = 3f;
        ...
        [SerializeField]
        [Range(0, 5f)]
        private float m_MoonHaloIntensity = 1f;
        ...
        [SerializeField]
        [Range(0, 5f)]
        private float m_StarsIntensity = 1;
